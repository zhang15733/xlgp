                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="active">
                                    <i class="fa fa-fw fa-gear"></i> Sign Up
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-info">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><i class="fa fa-user fa-fw"></i> Add User</h3>
                                </div>
                                <div class="panel-body">
                                    ...
                                    <button class="btn btn-lg btn-success btn-block" type="submit">Add User</button>
